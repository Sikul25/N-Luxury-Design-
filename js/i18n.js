(function () {
  const STRINGS = {
    en: {
      ...
      'nav.cart': 'Cart',
      'hero.eyebrow': 'LUXURY DESIGN',
      'hero.title': 'Handcrafted elegance,\nseason after season.',
      'hero.subtitle': 'Discover the latest collection — clothing and jewelry designed and photographed by hand.',
    ...
    ru: {
      ...
      'hero.subtitle': 'Откройте для себя новую коллекцию — одежда и украшения, созданные и сфотографированные вручную.',
    ...
    fr: {
      ...
      'hero.subtitle': 'Découvrez la dernière collection — vêtements et bijoux conçus et photographiés à la main.',
    ...
    es: {
      ...
      'hero.subtitle': 'Descubre la última colección: ropa y joyas diseñadas y fotografiadas a mano.',
    ...
    it: {
      ...
      'hero.subtitle': 'Scopri l\'ultima collezione: abiti e gioielli progettati e fotografati a mano.',
