(function () {
  const STRINGS = {
    ...
    ru: {
      ...
      'hero.subtitle': 'Откройте для себя нашу новую коллекцию — подборку исключительных изделий, созданных вручную с любовью, точностью и изяществом.',
    ...
    fr: {
      ...
      'hero.subtitle': 'Découvrez notre nouvelle collection — une sélection de pièces d’exception, confectionnées à la main avec passion, précision et raffinement.',
    ...
    es: {
      ...
      'hero.subtitle': 'Descubre nuestra nueva colección — una selección de piezas excepcionales, hechas a mano con pasión, precisión y refinamiento.',
    ...
    it: {
      ...
      'hero.subtitle': 'Scopri la nostra nuova collezione — una selezione di pezzi eccezionali, fatti a mano con passione, precisione e raffinatezza.',
