(function () {
  const STRINGS = {
    ...
    ru: {
      ...
      'hero.subtitle': 'Откройте для себя новую коллекцию — одежда и украшения ручной работы, созданные с заботой.',
    ...
    es: {
      ...
      'hero.subtitle': 'Descubre la última colección: ropa y joyas hechas a mano, con dedicación.',
